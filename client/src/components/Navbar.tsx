        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link 
              ...
              className="hidden md:flex items-center gap-2 px-3 py-2 rounded-full bg-gradient-to-r from-purple-100 to-blue-100 text-purple-700 hover:from-purple-200 hover:to-blue-200 transition-colors duration-200"
            >
            ...
            <Link to="/wishlist" className="hidden md:flex relative items-center justify-center p-2 rounded-full hover:bg-gray-100 transition-colors duration-200">
              ...
              {wishlistItems.length > 0 && (
                <Badge variant="destructive" className="absolute -top-1 -right-1 h-5 min-w-5 p-0 flex items-center justify-center rounded-full text-xs">
